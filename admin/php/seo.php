...
<img src="../assets/img/<?=$data['icon']?>" class="img-thumbnail ooo">
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
      ...
      <input type="name" name="title" value="<?=$data['title']?>" class="form-control" id="name" placeholder="Your Name">
    </div>
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" name="keywords" value="<?=$data['keyword']?>" class="form-control" id="email" placeholder="Enter Keywords here">
    </div>
    <div class="form-group col-md-12">

...
?> 
  ...
  <option value="pe">Pofessional Experience</option>
    ...
    <input type="text" name="title" class="form-control" id="website" placeholder="Btech" required>
  </div>
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" class="form-control" id="website" placeholder="Working at XYZ India Pvt. Ltd. , India" required>
  </div>
   <div class="form-group col-md-4">
  ...
  <div class="form-group col-md-12">
    ...
    <textarea class="form-control" name="workdesc" id="exampleFormControlTextarea1" rows="3" placeholder="wite about you"></textarea>
  </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (leave blank if you dont want to)</label>
    <textarea class="form-control" name="workdesc" id="exampleFormControlTextarea1" rows="3" placeholder="write about you"><?=$data2['workdesc']?></textarea>
  </div>
